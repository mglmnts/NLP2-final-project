...
def run_experiment_B(id="B") -> None:
    ...
    gc.collect()
    checkpoint_path: str = (
        "/mnt/c/Users/202105503/Data/NLP2-final-project/data/final-model-train/A/runs/checkpoint-1200"
    )
    model_interface: ModelInterface
    model_interface = ModelInterface.from_checkpoint(checkpoint_path=checkpoint_path)
    model_interface.load_dataset(interface=dataset_interface)
...
def run_experiment_C(id="C") -> None:
    ...
    dataset_paths: list[str] = [DATASETS[2], DATASETS[3]]
    dataset_interface: DatasetInterface = DatasetInterface.merge(
        dataset_paths=dataset_paths, shuffle=True
    )
